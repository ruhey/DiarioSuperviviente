...
public class Prueba extends DiaryBaseActivity implements View.OnClickListener{
    //UI References
    ...
    private void findViewsById() {
        fecha = (EditText) findViewById(R.id.fechaPrueba);
        fecha.setInputType(InputType.TYPE_NULL);
        fecha.requestFocus();

        hora = (EditText) findViewById(R.id.horaPrueba);
