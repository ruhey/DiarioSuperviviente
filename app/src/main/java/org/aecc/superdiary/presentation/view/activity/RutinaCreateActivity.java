...
public class RutinaCreateActivity extends BaseActivity implements RutinaDetailCreateView, HasComponent<RoutineComponent> {
    ...
    @Inject
    RoutineDetailCreatePresenter routineDetailCreatePresenter;
    ...
    public static Intent getCallingIntent(Context context) {
        Intent callingIntent = new Intent(context, RutinaCreateActivity.class);
    ...
    public void editRoutine(){
        Routine routine = new Routine(55);
        ...
        this.routineDetailCreatePresenter.createRoutine(routine);
    }
    ...
    @Override public void onResume() {
        super.onResume();
        this.routineDetailCreatePresenter.resume();
    }
