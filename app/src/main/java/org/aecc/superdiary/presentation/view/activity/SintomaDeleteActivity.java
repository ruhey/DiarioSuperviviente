...
public class SintomaDeleteActivity extends BaseActivity implements SintomaDetailDeleteView, HasComponent<SymptomComponent> {
    ...
    @Inject
    SymptomDetailDeletePresenter symptomDetailDeletePresenter;
    ...
    public static Intent getCallingIntent(Context context, int symptomId) {
        Intent callingIntent = new Intent(context, SintomaDeleteActivity.class);
